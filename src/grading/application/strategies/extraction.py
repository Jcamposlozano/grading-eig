...
from grading.ports.audio_extractor_port import AudioExtractorPort
from grading.ports.document_extractor_port import DocumentExtractorPort
from grading.ports.transcription_port import TranscriptionPort
