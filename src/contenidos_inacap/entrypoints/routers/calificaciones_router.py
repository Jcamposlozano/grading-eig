...
from contenidos_inacap.application.dto.calificacion_dto import (
...
def get_queue_dep() -> QueuePort:
    from contenidos_inacap.shared.container import get_queue

    return get_queue()


def get_storage_dep() -> StoragePort:
    from contenidos_inacap.shared.container import get_object_storage

    return get_object_storage()


def get_rubric_dep() -> RubricPort:
    from contenidos_inacap.shared.container import get_rubric_store
